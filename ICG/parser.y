...
Identifier_List
    ...
    | IDENTIFIER ',' Identifier_List        {   redeclaration_error_check($1);
                                                symTabInsert(symbol_table,$1 , curr_scope->scope_num, datatype, "", yylineno);
                                            }
    | '*' IDENTIFIER ',' Identifier_List    {
                                                ...
                                                datatype[len] = '*';
                                                datatype[len +1] = '\0';
                                                symTabInsert(symbol_table,$2 , curr_scope->scope_num, datatype, "", yylineno);
                                                datatype[len] = '\0';
                                            }
...
Function_Declaration
        : Type IDENTIFIER Bracket_open Formal_Param_List ')' ';'    {          
                                                                        ...
                                                                        symbol_node_t *node = symTabInsert(symbol_table,$2, curr_scope->scope_num, funcType, "", yylineno);
...
Formal_Param_List
	: VOID
    | Type IDENTIFIER                                  { num_params++; void_param_check($1); symTabInsert(symbol_table,$2 , curr_scope->scope_num, $1, "", yylineno);trace("Formal_Param_List Rule 1\n");}
	| Type '*' IDENTIFIER                              { num_params++; void_param_check($1); symTabInsert(symbol_table,$3 , curr_scope->scope_num, $1, "", yylineno);trace("Formal_Param_List Rule 2\n");}
	| Type Array_Notation                              { num_params++; void_param_check($1); trace("Formal_Param_List Rule 3\n");}
	| Type IDENTIFIER ',' Formal_Param_List            { num_params++; void_param_check($1); symTabInsert(symbol_table,$2 , curr_scope->scope_num, $1, "", yylineno);trace("Formal_Param_List Rule 4\n");}
	| Type '*' IDENTIFIER ',' Formal_Param_List        { num_params++; void_param_check($1); symTabInsert(symbol_table,$3 , curr_scope->scope_num, $1, "", yylineno);trace("Formal_Param_List Rule 5\n");}
...
Array_Notation
    : IDENTIFIER '[' CONSTANT_INTEGER ']'   {   
                                                ...
                                                symTabInsert(symbol_table,$1, curr_scope->scope_num, arrayType, $3, yylineno);
    ...
    | '*' IDENTIFIER '[' CONSTANT_INTEGER ']'   {   
                                                    ...
                                                    datatype[len +1] = '\0';                                
                                                    char arrayType[100] = "Array: ";strcat(arrayType, datatype);
                                                    symTabInsert(symbol_table,$2, curr_scope->scope_num, arrayType, $4, yylineno);
                                                    datatype[len] = '\0';
...
Define_Assign
    : IDENTIFIER Assignment_Operator Expression             {
                                                                ...
                                                                curr_buff = get_new_node(TAC_code);
                                                                stackPush(three_address_code_stack, $1);
...
Primary
    : '(' Expression ')'    
    | '(' Assignment ')'
    | CONSTANT_INTEGER     {stackPush(three_address_code_stack, $1);symTabInsert(constant_table, $1, -1, "int", "", yylineno); trace("CONSTANT_INTEGER\n");}
    | CONSTANT_FLOAT       {stackPush(three_address_code_stack, $1);symTabInsert(constant_table, $1, -1, "float", "", yylineno); trace("CONSTANT_FLOAT\n");}
    | CONSTANT_CHAR        {stackPush(three_address_code_stack, $1);symTabInsert(constant_table, $1, -1, "char", "", yylineno); trace("CONSTANT_CHAR\n");}
    | CONSTANT_STRING      {stackPush(three_address_code_stack, $1);symTabInsert(constant_table, $1, -1, "string", "", yylineno); trace("CONSTANT_STRING\n");}
    | IDENTIFIER           {stackPush(three_address_code_stack, $1); scope_error_check($1);trace("Primary Identifier\n");}
    | '*' IDENTIFIER       {stackPush(three_address_code_stack, $2); scope_error_check($2);trace("Pointer Identifier\n");}
    | '&' IDENTIFIER       {stackPush(three_address_code_stack, $2); scope_error_check($2);trace("Address of Identifier\n");}
    | '-' Primary
    | '+' Primary
    | Array_Notation
    | Function_Call
...
Function_Call
    : IDENTIFIER Bracket_open Param_List ')'     { scope_error_check($1); num_param_check($1); check_is_function($1); /*symTabInsert(symbol_table, $1, curr_scope->scope_num, "Function", "", yylineno);trace("Function Call\n"); */} 
    ;
