...
static const yytype_uint16 yyrline[] =
{
      ...
      95,    99,   100,   103,   111,   112,   115,   123,   124,   128,
     141,   139,   165,   169,   170,   171,   172,   173,   174,   175,
     176,   180,   181,   182,   183,   184,   185,   186,   187,   188,
     192,   192,   192,   192,   196,   202,   213,   220,   223,   226,
     234,   251,   255,   259,   260,   261,   265,   281,   282,   283,
     287,   288,   289,   290,   291,   292,   293,   294,   295,   296,
     297,   301,   305,   306,   310,   314,   330,   331,   335,   339,
     343,   347,   351,   358,   359,   363,   371,   372,   376,   380,
     387,   388,   389,   390,   391,   392,   393,   394,   395,   396,
     397,   398,   399,   400,   401,   402,   403,   407,   411,   416,
     420,   421,   422,   426,   427,   428,   429,   430,   431,   432,
     433,   434,   439,   444,   448,   452,   458,   467,   477,   490,
     500,   511,   531,   554,   558,   568,   581,   586,   592,   592,
     603,   603,   614,   614,   625,   625,   639,   655,   664,   668,
     669,   673
};
#endif
...
#line 100 "parser.y" /* yacc.c:1646  */
    {   redeclaration_error_check((yyvsp[-2].char_ptr));
                                                symTabInsert(symbol_table,(yyvsp[-2].char_ptr) , curr_scope->scope_num, datatype, "", yylineno);
                                            }
...
#line 112 "parser.y" /* yacc.c:1646  */
    {   
                                                ...
                                                symTabInsert(symbol_table,(yyvsp[0].char_ptr) , curr_scope->scope_num, datatype, "", yylineno);}
...
#line 128 "parser.y" /* yacc.c:1646  */
    {          
                                                                        ...
                                                                        symbol_node_t *node = symTabInsert(symbol_table,(yyvsp[-4].char_ptr), curr_scope->scope_num, funcType, "", yylineno);
...
#line 145 "parser.y" /* yacc.c:1646  */
    {          
                                    ...
                                    strcat(funcType, datatype);
                                    if(!node) {
                                        symbol_node_t *node = symTabInsert(symbol_table,(yyvsp[-5].char_ptr), curr_scope->scope_num, funcType, "", yylineno);
                                        node->num_params = num_params;
                                    }
                                    else {
...
#line 170 "parser.y" /* yacc.c:1646  */
    { num_params++; void_param_check((yyvsp[-1].char_ptr)); symTabInsert(symbol_table,(yyvsp[0].char_ptr) , curr_scope->scope_num, (yyvsp[-1].char_ptr), "", yylineno);trace("Formal_Param_List Rule 1\n");}
#line 1684 "y.tab.c" /* yacc.c:1646  */
    break;

  case 25:
#line 171 "parser.y" /* yacc.c:1646  */
    { num_params++; void_param_check((yyvsp[-2].char_ptr)); symTabInsert(symbol_table,(yyvsp[0].char_ptr) , curr_scope->scope_num, (yyvsp[-2].char_ptr), "", yylineno);trace("Formal_Param_List Rule 2\n");}
...
#line 173 "parser.y" /* yacc.c:1646  */
    { num_params++; void_param_check((yyvsp[-3].char_ptr)); symTabInsert(symbol_table,(yyvsp[-2].char_ptr) , curr_scope->scope_num, (yyvsp[-3].char_ptr), "", yylineno);trace("Formal_Param_List Rule 4\n");}
#line 1702 "y.tab.c" /* yacc.c:1646  */
    break;

  case 28:
#line 174 "parser.y" /* yacc.c:1646  */
    { num_params++; void_param_check((yyvsp[-4].char_ptr)); symTabInsert(symbol_table,(yyvsp[-2].char_ptr) , curr_scope->scope_num, (yyvsp[-4].char_ptr), "", yylineno);trace("Formal_Param_List Rule 5\n");}
...
#line 196 "parser.y" /* yacc.c:1646  */
    {   
                                                ...
                                                symTabInsert(symbol_table,(yyvsp[-3].char_ptr), curr_scope->scope_num, arrayType, (yyvsp[-1].char_ptr), yylineno);
...
#line 234 "parser.y" /* yacc.c:1646  */
    {
                                                                ...
                                                                stack_node op = stackPop(three_address_code_stack);
                                                                curr_buff = get_new_node(TAC_code);
                                                                stackPush(three_address_code_stack, (yyvsp[-2].char_ptr));
...
#line 314 "parser.y" /* yacc.c:1646  */
    {
                                                                stack_node op = stackPop(three_address_code_stack);
                                                                curr_buff = get_new_node(TAC_code);
                                                                stackPush(three_address_code_stack, TEMP_VAR);
                                                                stackTop(three_address_code_stack, curr_buff);
...
#line 389 "parser.y" /* yacc.c:1646  */
    {stackPush(three_address_code_stack, (yyvsp[0].char_ptr));symTabInsert(constant_table, (yyvsp[0].char_ptr), -1, "int", "", yylineno); trace("CONSTANT_INTEGER\n");}
#line 2048 "y.tab.c" /* yacc.c:1646  */
    break;

  case 93:
#line 390 "parser.y" /* yacc.c:1646  */
    {stackPush(three_address_code_stack, (yyvsp[0].char_ptr));symTabInsert(constant_table, (yyvsp[0].char_ptr), -1, "float", "", yylineno); trace("CONSTANT_FLOAT\n");}
#line 2054 "y.tab.c" /* yacc.c:1646  */
    break;

  case 94:
#line 391 "parser.y" /* yacc.c:1646  */
    {stackPush(three_address_code_stack, (yyvsp[0].char_ptr));symTabInsert(constant_table, (yyvsp[0].char_ptr), -1, "char", "", yylineno); trace("CONSTANT_CHAR\n");}
#line 2060 "y.tab.c" /* yacc.c:1646  */
    break;

  case 95:
#line 392 "parser.y" /* yacc.c:1646  */
    {stackPush(three_address_code_stack, (yyvsp[0].char_ptr));symTabInsert(constant_table, (yyvsp[0].char_ptr), -1, "string", "", yylineno); trace("CONSTANT_STRING\n");}
#line 2066 "y.tab.c" /* yacc.c:1646  */
    break;

  case 96:
#line 393 "parser.y" /* yacc.c:1646  */
    {stackPush(three_address_code_stack, (yyvsp[0].char_ptr)); scope_error_check((yyvsp[0].char_ptr));trace("Primary Identifier\n");}
#line 2072 "y.tab.c" /* yacc.c:1646  */
    break;

  case 97:
#line 394 "parser.y" /* yacc.c:1646  */
    {stackPush(three_address_code_stack, (yyvsp[0].char_ptr)); scope_error_check((yyvsp[0].char_ptr));trace("Pointer Identifier\n");}
#line 2078 "y.tab.c" /* yacc.c:1646  */
    break;

  case 98:
#line 395 "parser.y" /* yacc.c:1646  */
    {stackPush(three_address_code_stack, (yyvsp[0].char_ptr)); scope_error_check((yyvsp[0].char_ptr));trace("Address of Identifier\n");}
...
#line 477 "parser.y" /* yacc.c:1646  */
    {
            stack_node reg = stackPop(three_address_code_stack);
            curr_buff = get_new_node(TAC_code);
...
#line 664 "parser.y" /* yacc.c:1646  */
    { scope_error_check((yyvsp[-3].char_ptr)); num_param_check((yyvsp[-3].char_ptr)); check_is_function((yyvsp[-3].char_ptr)); /*symTabInsert(symbol_table, $1, curr_scope->scope_num, "Function", "", yylineno);trace("Function Call\n"); */}
...
inline void print_TAC_operator(char *op) {
    ...
    curr_buff = get_new_node(TAC_code);
    stack_node op2 = stackPop(three_address_code_stack);
    stack_node op1 = stackPop(three_address_code_stack);
...
inline void arr_subscript_check(char *symbol){
    symbol_node_t *node = symTabFind(symbol_table, symbol);
...
inline void check_is_function(char *func_name) {
    ...
    symbol_node_t *node = symTabFind(symbol_table, func_name);
    if(node == NULL) {
...
int main()
{
    ...
    symTabInit(symbol_table);
    symTabInit(constant_table);
    three_address_code_stack = stackInit();
    
    TAC_code = codeStackInit();
    printf("\n");
    ...
    symTabFree(symbol_table);
    symTabFree(constant_table);
    // TODO: Free Scope
    stackFree(three_address_code_stack);
    return 0;
}
